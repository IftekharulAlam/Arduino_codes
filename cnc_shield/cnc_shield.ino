...
void loop(){
  ...
  //step(false, Z_DIR, Z_STP, 100); // z axis motor rotates CCW for 1 circle, as in 200 steps
  delay(1000);
  ...
  //step(true, Z_DIR, Z_STP, 100); // z axis motor rotates CW for 1 circle, as in 200 steps
  delay(1000);
}
