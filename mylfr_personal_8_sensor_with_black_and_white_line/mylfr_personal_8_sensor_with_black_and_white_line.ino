...
void loop()
{
  ...
  if (obstacle_sonar_distance == 5) {
    ...
    if (s[0] == 0 && s[1] == 0 && s[2] == 0 && s[3] == 1 && s[4] == 1 && s[5] == 1 && s[6] == 0 && s[7] == 0
        || s[0] == 0 && s[1] == 0 && s[2] == 0 && s[3] == 0 && s[4] == 1 && s[5] == 1 && s[6] == 0 && s[7] == 0 ||
        s[0] == 0 && s[1] == 0 && s[2] == 0 && s[3] == 1 && s[4] == 1 && s[5] == 0 && s[6] == 0 && s[7] == 0 ||
        s[0] == 0 && s[1] == 0 && s[2] == 0 && s[3] == 0 && s[4] == 1 && s[5] == 0 && s[6] == 0 && s[7] == 0 )
    {
      white_line = false;
    }
    if (s[0] == 1 && s[1] == 1 && s[2] == 1 && s[3] == 0 && s[4] == 0 && s[5] == 0 && s[6] == 1 && s[7] == 1 ||
        s[0] == 1 && s[1] == 1 && s[2] == 1 && s[3] == 1 && s[4] == 0 && s[5] == 0 && s[6] == 1 && s[7] == 1 ||
        s[0] == 1 && s[1] == 1 && s[2] == 1 && s[3] == 0 && s[4] == 0 && s[5] == 1 && s[6] == 1 && s[7] == 1 ||
        s[0] == 1 && s[1] == 1 && s[2] == 1 && s[3] == 1 && s[4] == 0 && s[5] == 1 && s[6] == 1 && s[7] == 1)
    {
      white_line = true;
    }
...
void wall_follow()
{
  int error, corr, final_l, final_r;
  float p, d, I = 0;
  error =  distance_from_sonar( wall_sonar_trigPin,  wall_sonar_echoPin);
  p = kp_sonar * error;
